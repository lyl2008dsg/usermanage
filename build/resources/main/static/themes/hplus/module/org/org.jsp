...
<jsp:directive.include file="/themes/hplus/incluld/top.jsp" />
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    ...
                    <strong>ORG jsTree</strong>是一个基于jQuery的Tree控件。支持 XML，JSON，Html三种数据源。提供创建，重命名，移动，删除，拖放节点操作。可以自己自定义创建，删除，嵌套，重命名，选择节点的规则。在这些操作上可以添加多种监听事件。
...
<script src="themes/hplus/js/jquery.min.js?v=2.1.4"></script>
<script src="themes/hplus/js/bootstrap.min.js?v=3.3.6"></script>
<script src="themes/hplus/js/content.min.js?v=1.0.0"></script>
<script src="themes/hplus/js/plugins/jsTree/jstree.min.js"></script>
<style>
