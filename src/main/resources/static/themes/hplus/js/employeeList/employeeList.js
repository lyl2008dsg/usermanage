 ...
 */
function initTable(){
    var table = $('#employee_list_table_id').DataTable( {
        "dom": '<"toolbar">frtip',
        "processing": true,
        "serverSide": true,
        "searching": false,
        ...
        "ordering": false,
        "ajax": {
            url: basePath+"hr/employees?start=0&limit=10",
            "dataSrc": "data",
            dataType: "jsonp",
        ...
        "columnDefs": [
            ...
            {
                "render": function ( data, type, row ) {
                    return "<button class='btn btn-info '   type='button' onclick='detail(\"" + row.employee_no + "\", 0)'><i class='fa fa-paste'></i> 详情</button>";
                },
                "targets": 5
            }
        ],
