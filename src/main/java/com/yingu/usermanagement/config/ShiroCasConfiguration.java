...
import com.yingu.usermanagement.security.MyShiroCasRealm;
...
public class ShiroCasConfiguration {
    ...
    // CasServerUrlPrefix
//    public static final String casServerUrlPrefix="https://www.smartscity.com/cas";
    public static final String casServerUrlPrefix="https://cas.yingu.com/cas";
    // Cas登录页面地址
    public static final String casLoginUrl = casServerUrlPrefix + "/login";
    // Cas登出页面地址
    public static final String casLogoutUrl = casServerUrlPrefix + "/logout";
    // 当前工程对外提供的服务地址
//    public static final String shiroServerUrlPrefix = "http://jack:9090/myspringboot";
    public static final String shiroServerUrlPrefix = "https://localhost:5443";
